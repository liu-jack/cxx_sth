...
CrossServerSession::HandlerArray CrossServerSession::RegisteServerHandlers( void )
{
	...
	handlers[ pb::SR2E_REGISTER ]       =&CrossServerSession::HandleRegister ;
	handlers[ pb::SR2E_EVENT ]          =&CrossServerSession::HandleServerEvent ;
...
CrossServerSession::~CrossServerSession( void )
{
	sEventLogSvr.CrossServerUnRegister( this ) ;
}
...
void CrossServerSession::HandleRegister( NetPack &packet )
{
	...
	EventLogServer::ServerRegisterResult ret =sEventLogSvr.CrossServerRegister( this ) ;
	switch( ret )
	{
...
void CrossServerSession::HandleServerEvent( NetPack &packet )
{
