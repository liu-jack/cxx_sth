...
EventLogServerClient::HandlerArray EventLogServerClient::RegisteHandlers( void )
{
	...
	handlers[ pb::SB2E_REGISTER_RET ]     =&EventLogServerClient::HandleRegisterRet ;
...
EventLogServerClient::EventLogServerClient( void )
{
	...
	SetPingDiffMS( sLobbySvr.Config().GetInt( "EventLogServer.ping_time_ms", 5000 ) ) ;
