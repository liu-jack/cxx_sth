...
class BranchFubenInfo : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_is_take_award() const;
  inline void clear_is_take_award();
  static const int kIsTakeAwardFieldNumber = 3;
  inline bool is_take_award() const;
  inline void set_is_take_award(bool value);
 ...
 private:
  ...
  inline void set_has_is_take_award();
  inline void clear_has_is_take_award();
...
class GS2C_take_branch_fuben_star_rsp : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_branch_stageid() const;
  inline void clear_branch_stageid();
  static const int kBranchStageIdFieldNumber = 3;
  inline ::google::protobuf::uint32 branch_stageid() const;
  inline void set_branch_stageid(::google::protobuf::uint32 value);
...
class GS2C_Fuben_All_Info : public ::google::protobuf::Message {
 public:
  ...
  inline int hide_fuben_infos_size() const;
  inline void clear_hide_fuben_infos();
  static const int kHideFubenInfosFieldNumber = 4;
  inline const ::pb::HideFubenInfo& hide_fuben_infos(int index) const;
  inline ::pb::HideFubenInfo* mutable_hide_fuben_infos(int index);
  inline ::pb::HideFubenInfo* add_hide_fuben_infos();
  inline const ::google::protobuf::RepeatedPtrField< ::pb::HideFubenInfo >&
      hide_fuben_infos() const;
  inline ::google::protobuf::RepeatedPtrField< ::pb::HideFubenInfo >*
      mutable_hide_fuben_infos();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::pb::HideFubenInfo > hide_fuben_infos_;
...
// optional bool is_take_award = 3;
inline bool BranchFubenInfo::has_is_take_award() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BranchFubenInfo::set_has_is_take_award() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BranchFubenInfo::clear_has_is_take_award() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BranchFubenInfo::clear_is_take_award() {
  is_take_award_ = false;
  clear_has_is_take_award();
}
inline bool BranchFubenInfo::is_take_award() const {
  return is_take_award_;
}
inline void BranchFubenInfo::set_is_take_award(bool value) {
  set_has_is_take_award();
  is_take_award_ = value;
}
...
// optional uint32 branch_stageId = 3;
inline bool GS2C_take_branch_fuben_star_rsp::has_branch_stageid() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void GS2C_take_branch_fuben_star_rsp::set_has_branch_stageid() {
  _has_bits_[0] |= 0x00000004u;
}
inline void GS2C_take_branch_fuben_star_rsp::clear_has_branch_stageid() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void GS2C_take_branch_fuben_star_rsp::clear_branch_stageid() {
  branch_stageid_ = 0u;
  clear_has_branch_stageid();
}
inline ::google::protobuf::uint32 GS2C_take_branch_fuben_star_rsp::branch_stageid() const {
  return branch_stageid_;
}
inline void GS2C_take_branch_fuben_star_rsp::set_branch_stageid(::google::protobuf::uint32 value) {
  set_has_branch_stageid();
  branch_stageid_ = value;
}
...
// repeated uint32 NR_stars = 3;
inline int GS2C_Fuben_All_Info::nr_stars_size() const {
  return nr_stars_.size();
}
inline void GS2C_Fuben_All_Info::clear_nr_stars() {
  nr_stars_.Clear();
}
inline ::google::protobuf::uint32 GS2C_Fuben_All_Info::nr_stars(int index) const {
  return nr_stars_.Get(index);
}
inline void GS2C_Fuben_All_Info::set_nr_stars(int index, ::google::protobuf::uint32 value) {
  nr_stars_.Set(index, value);
}
inline void GS2C_Fuben_All_Info::add_nr_stars(::google::protobuf::uint32 value) {
  nr_stars_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
GS2C_Fuben_All_Info::nr_stars() const {
  return nr_stars_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
GS2C_Fuben_All_Info::mutable_nr_stars() {
  return &nr_stars_;
}

// repeated .pb.HideFubenInfo hide_fuben_infos = 4;
inline int GS2C_Fuben_All_Info::hide_fuben_infos_size() const {
  return hide_fuben_infos_.size();
}
inline void GS2C_Fuben_All_Info::clear_hide_fuben_infos() {
  hide_fuben_infos_.Clear();
}
inline const ::pb::HideFubenInfo& GS2C_Fuben_All_Info::hide_fuben_infos(int index) const {
  return hide_fuben_infos_.Get(index);
}
inline ::pb::HideFubenInfo* GS2C_Fuben_All_Info::mutable_hide_fuben_infos(int index) {
  return hide_fuben_infos_.Mutable(index);
}
inline ::pb::HideFubenInfo* GS2C_Fuben_All_Info::add_hide_fuben_infos() {
  return hide_fuben_infos_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::pb::HideFubenInfo >&
GS2C_Fuben_All_Info::hide_fuben_infos() const {
  return hide_fuben_infos_;
}
inline ::google::protobuf::RepeatedPtrField< ::pb::HideFubenInfo >*
GS2C_Fuben_All_Info::mutable_hide_fuben_infos() {
  return &hide_fuben_infos_;
}
