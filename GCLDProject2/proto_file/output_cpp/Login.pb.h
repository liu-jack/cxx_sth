...
class SGetServerList : public ::google::protobuf::Message {
 public:
  ...
  inline int roles_info_size() const;
  inline void clear_roles_info();
  static const int kRolesInfoFieldNumber = 5;
  inline const ::pb::RoleInfo& roles_info(int index) const;
  inline ::pb::RoleInfo* mutable_roles_info(int index);
  inline ::pb::RoleInfo* add_roles_info();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::pb::RoleInfo > roles_info_;
  ::google::protobuf::uint32 server_id_;
...
inline void RoleInfo::set_has_server_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RoleInfo::clear_has_server_id() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::uint32 RoleInfo::server_id() const {
  return server_id_;
}
inline void RoleInfo::set_server_id(::google::protobuf::uint32 value) {
  set_has_server_id();
  server_id_ = value;
}
...
inline ::google::protobuf::uint32 RoleInfo::viplevel() const {
  return viplevel_;
}
inline void RoleInfo::set_viplevel(::google::protobuf::uint32 value) {
  set_has_viplevel();
  viplevel_ = value;
}

// optional uint32 headicon = 5;
inline bool RoleInfo::has_headicon() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void RoleInfo::set_has_headicon() {
  _has_bits_[0] |= 0x00000010u;
}
inline void RoleInfo::clear_has_headicon() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void RoleInfo::clear_headicon() {
  headicon_ = 0u;
  clear_has_headicon();
}
inline ::google::protobuf::uint32 RoleInfo::headicon() const {
  return headicon_;
}
inline void RoleInfo::set_headicon(::google::protobuf::uint32 value) {
  set_has_headicon();
  headicon_ = value;
}

// optional uint64 login_time = 6;
inline bool RoleInfo::has_login_time() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void RoleInfo::set_has_login_time() {
  _has_bits_[0] |= 0x00000020u;
}
inline void RoleInfo::clear_has_login_time() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void RoleInfo::clear_login_time() {
  login_time_ = GOOGLE_ULONGLONG(0);
  clear_has_login_time();
}
inline ::google::protobuf::uint64 RoleInfo::login_time() const {
  return login_time_;
}
inline void RoleInfo::set_login_time(::google::protobuf::uint64 value) {
  set_has_login_time();
  login_time_ = value;
}

// optional .pb.ServerState server_state = 7;
inline bool RoleInfo::has_server_state() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void RoleInfo::set_has_server_state() {
  _has_bits_[0] |= 0x00000040u;
}
inline void RoleInfo::clear_has_server_state() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void RoleInfo::clear_server_state() {
  server_state_ = 0;
  clear_has_server_state();
}
inline ::pb::ServerState RoleInfo::server_state() const {
  return static_cast< ::pb::ServerState >(server_state_);
}
inline void RoleInfo::set_server_state(::pb::ServerState value) {
...
// repeated .pb.RoleInfo roles_info = 5;
inline int SGetServerList::roles_info_size() const {
  return roles_info_.size();
}
inline void SGetServerList::clear_roles_info() {
  roles_info_.Clear();
}
inline const ::pb::RoleInfo& SGetServerList::roles_info(int index) const {
  return roles_info_.Get(index);
}
inline ::pb::RoleInfo* SGetServerList::mutable_roles_info(int index) {
  return roles_info_.Mutable(index);
}
inline ::pb::RoleInfo* SGetServerList::add_roles_info() {
  return roles_info_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::pb::RoleInfo >&
SGetServerList::roles_info() const {
  return roles_info_;
}
inline ::google::protobuf::RepeatedPtrField< ::pb::RoleInfo >*
SGetServerList::mutable_roles_info() {
  return &roles_info_;
}
