...
#ifndef PROTOBUF_ServerOpcode_2eproto__INCLUDED
#define PROTOBUF_ServerOpcode_2eproto__INCLUDED
...
enum ServerOpcode {
  ...
  SG2L_BROADCAST = 19,
  SG2B_REGISTER = 20,
  SG2B_REGISTER_RET = 21,
  SG2R_REGISTER = 22,
  SG2R_REGISTER_RET = 23,
  SG2E_REGISTER = 24,
  SG2E_REGISTER_RET = 25,
  SG2E_EVENT = 26,
  SC2G_ADD_LOGIN_SERVERS = 27,
  SC2G_ADD_EVENT_LOG_SERVER = 28,
  SC2G_ADD_CROSS_SERVERS = 29,
  SC2G_WEB_GET_PLAYER_LIST = 30,
  SC2G_WEB_GET_PLAYER_LIST_RET = 31,
  SC2G_WEB_PAY = 32,
  SC2G_WEB_PAY_RET = 33,
  SC2G_SEND_SERVERS_MAIL = 34,
  SC2G_SEND_PLAYER_MAIL = 35,
  SC2G_SEND_PLAYER_MAIL_RET = 36,
  SC2G_PLAYER_FORBID = 37,
  SC2G_PLAYER_FORBID_RET = 38,
  SC2G_SET_PLAYER_VIP = 39,
  SC2G_SET_PLAYER_VIP_RET = 40,
  SC2G_RECREATE_PAY_ORDER = 41,
  SC2G_RECREATE_PAY_ORDER_RET = 42,
  SC2G_SEND_SERVERS_NOTICE = 43,
  SC2G_SERVERS_HOT_RES_RELOAD = 44,
  SC2G_GET_ONLINE_PLAYER_COUNT = 45,
  SG2C_GET_ONLINE_PLAYER_COUNT_RET = 46,
  SC2G_GET_SERVER_INFO = 47,
  SG2C_GET_SERVER_INFO_RET = 48,
  SC2G_SERVERS_HOT_PAY_ITEM_RELOAD = 49,
  SC2G_SERVERS_SAVE_DBPROXY = 50,
  SC2L_BROADCAST = 51,
  SC2L_ADD_EVENT_LOG_SERVER = 52,
  SC2B_ADD_EVENT_LOG_SERVER = 53,
  SC2R_ADD_EVENT_LOG_SERVER = 54,
  SR2C_REGISTER = 55,
  SR2C_REGISTER_RET = 56,
  SR2C_GET_LOBBY_SERVER = 57,
  SR2C_GET_LOBBY_SERVER_RET = 58,
  SR2C_GET_EVENT_LOG_SERVER = 59,
  SR2C_GET_EVENT_LOG_SERVER_RET = 60,
  SR2C_GET_GAME_SERVERS = 61,
  SR2C_GET_GAME_SERVERS_RET = 62,
  SR2B_REGISTER = 63,
  SR2B_REGISTER_RET = 64,
  SR2G_REGISTER = 65,
  SR2G_REGISTER_RET = 66,
  SR2E_REGISTER = 67,
  SR2E_REGISTER_RET = 68,
  SR2E_EVENT = 69,
  SB2C_REGISTER = 70,
  SB2C_REGISTER_RET = 71,
  SB2C_GET_EVENT_LOG_SERVER = 72,
  SB2C_GET_EVENT_LOG_SERVER_RET = 73,
  SB2E_REGISTER = 74,
  SB2E_REGISTER_RET = 75,
  SB2E_EVENT = 76,
  SL2E_REGISTER = 77,
  SL2E_REGISTER_RET = 78,
  SL2E_EVENT = 79,
  SL2C_REGISTER = 80,
  SL2C_REGISTER_RET = 81,
  SL2C_GET_EVENT_LOG_SERVER = 82,
  SL2C_GET_EVENT_LOG_SERVER_RET = 83,
  SE2C_REGISTER = 84,
  SE2C_REGISTER_RET = 85,
  SP2G_MAIL_MSG = 86,
  SD2G_LOADINGGUILDINFO = 87,
  SD2G_GUILD_SEARCH_PLAYERSINFO_RESPON = 88,
  SD2G_GET_SLOTITEMINFO = 89,
  SD2G_GET_PLAYERINFO_RESPON = 90,
  SD2G_IS_PLAYEREXIST_RESPON = 91,
  SD2G_LOADFRIENDINFO = 92,
  SD2G_SOCIAL_SEARCH_PLAYERSINFO_RESPON = 93,
  SD2G_GET_PLAYER_APPEND_DATA_RET = 94,
  SD2G_PLAYER_CACHE_DATA_SYNC = 95,
  SD2G_PLAYER_CACHE_REMOVE_SYNC = 96,
  SG2D_REGISTER = 120,
  ...
  SG2D_CREATE_PLAYER_DATA = 133,
  SG2D_UPDATA_STAGELEVEL_INFO = 134,
  SD2G_UPDATA_STAGELEVEL_INFO_RET = 135,
  SG2D_GET_SLOTITEMINFO = 136,
  SG2D_GET_PLAYERINFO = 137,
  SG2D_IS_PLAYEREXIST = 138,
  SG2D_UPDATE_GUILD_DATA = 139,
  SG2D_UPDATE_GUILD_MEMBER_DATA = 140,
  SG2D_GUILD_SEARCH_PLAYERSINFO = 141,
  SG2D_CREAT_GUILD = 142,
  SD2G_CREAT_GUILD_RET = 143,
  SG2D_UPDATE_FRIEND_DATA = 144,
  SG2D_SOCIAL_SEARCH_PLAYERSINFO = 145,
  SG2D_FRIEND_OPERATE = 146,
  SD2G_FRIEND_OPERATE_RET = 147,
  ...
  SG2D_PVP_ARENA_RANKING_LIST = 188,
  ...
  SW2C_GET_SERVER_LIST = 198,
  SW2C_GET_SERVER_LIST_RET = 199,
  SW2C_GET_PLAYER_LIST = 200,
  SW2C_GET_PLAYER_LIST_RET = 201,
  SW2C_PAY = 202,
  SW2C_PAY_RET = 203,
  ...
  SL2S_NOTICE_WAR_STATE = 300,
  SL2G_NOTICE_WAR_START = 301,
  SL2R_NOTICE_WAR_START = 302,
  SL2G_COLLECT_COUNTRY_INFO = 303,
  SG2L_COLLECT_COUNTRY_INFO_RET = 304,
  SL2G_DEVIDE_CROSS_SERVER = 305,
  SL2R_DEVIDE_CROSS_SERVER = 306,
  SG2R_UPDATE_PLAYER_VALUE = 307,
  SR2G_QUIT_CROSS_SERVER = 308,
  SG2R_OFFICE_INFO = 309,
  SR2G_Cross_Result_Country = 310,
  SG2R_UPDATE_PLAYER_CHAR_VALUE = 311,
  SR2G_NOTICE_CLOSE_CROSS = 312,
  SR2G_Change_Awards = 313,
  SG2R_Check_Can_Change_Hero = 314,
  SG2B_Ask_Cross_Info = 315,
  SB2G_Ask_Cross_Info_Ret = 316,
  SR2G_Award_Take_Player = 317,
  SG2D_UpdatePersonalEC = 350,
  SERVER_OPCODE_COUNT = 351
};
bool ServerOpcode_IsValid(int value);
const ServerOpcode ServerOpcode_MIN = S_PING;
const ServerOpcode ServerOpcode_MAX = SERVER_OPCODE_COUNT;
const int ServerOpcode_ARRAYSIZE = ServerOpcode_MAX + 1;

const ::google::protobuf::EnumDescriptor* ServerOpcode_descriptor();
inline const ::std::string& ServerOpcode_Name(ServerOpcode value) {
  return ::google::protobuf::internal::NameOfEnum(
    ServerOpcode_descriptor(), value);
}
inline bool ServerOpcode_Parse(
    const ::std::string& name, ServerOpcode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ServerOpcode>(
    ServerOpcode_descriptor(), name, value);
}
// ===================================================================
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::ServerOpcode>() {
  return ::pb::ServerOpcode_descriptor();
}
...
#endif  // PROTOBUF_ServerOpcode_2eproto__INCLUDED
