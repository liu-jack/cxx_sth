...
class GS2C_MapLogic_Init : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_personalec() const;
  inline void clear_personalec();
  static const int kPersonalEcFieldNumber = 14;
  inline const ::pb::SG2D_PersonalEC& personalec() const;
  inline ::pb::SG2D_PersonalEC* mutable_personalec();
  inline ::pb::SG2D_PersonalEC* release_personalec();
  inline void set_allocated_personalec(::pb::SG2D_PersonalEC* personalec);
 ...
 private:
  ...
  inline void set_has_personalec();
  inline void clear_has_personalec();
  ...
  ::pb::SG2D_PersonalEC* personalec_;
...
// optional .pb.SG2D_PersonalEC personalEc = 14;
inline bool GS2C_MapLogic_Init::has_personalec() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void GS2C_MapLogic_Init::set_has_personalec() {
  _has_bits_[0] |= 0x00002000u;
}
inline void GS2C_MapLogic_Init::clear_has_personalec() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void GS2C_MapLogic_Init::clear_personalec() {
  if (personalec_ != NULL) personalec_->::pb::SG2D_PersonalEC::Clear();
  clear_has_personalec();
}
inline const ::pb::SG2D_PersonalEC& GS2C_MapLogic_Init::personalec() const {
  return personalec_ != NULL ? *personalec_ : *default_instance_->personalec_;
}
inline ::pb::SG2D_PersonalEC* GS2C_MapLogic_Init::mutable_personalec() {
  set_has_personalec();
  if (personalec_ == NULL) personalec_ = new ::pb::SG2D_PersonalEC;
  return personalec_;
}
inline ::pb::SG2D_PersonalEC* GS2C_MapLogic_Init::release_personalec() {
  clear_has_personalec();
  ::pb::SG2D_PersonalEC* temp = personalec_;
  personalec_ = NULL;
  return temp;
}
inline void GS2C_MapLogic_Init::set_allocated_personalec(::pb::SG2D_PersonalEC* personalec) {
  delete personalec_;
  personalec_ = personalec;
  if (personalec) {
    set_has_personalec();
  } else {
    clear_has_personalec();
