...
void CongratulateLogDB::SendInfoToSelfCongratulateDb(Player& player, CongratulateLog& log,const uint64 act_time,const uint32 operate_type)
{
	pb::GxDB_CongratulateInfo msg;
	msg.set_operate_type(operate_type);
	log.SaveTo(act_time,msg);
