...
public:
	...
	void SendEventInfo( uint32 eventId, PlayerSession &session, int paramCount, ... ) ;

	void SendEventInfo( uint32 eventId, uint64 playerId, uint64 accountId,int paramCount, ... ) ;
