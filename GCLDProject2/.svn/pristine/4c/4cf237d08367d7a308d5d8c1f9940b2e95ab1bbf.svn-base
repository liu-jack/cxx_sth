...
bool ItemEquip::CheckUpdateSameAtrrMaxLv()
{
	uint32 curAttr = 0;
	bool   isSameAtrr = true;
	bool   isSameMaxLevel = true;
...
bool ItemEquip::IsHasMiji() const
{
	const uint32 max_star_count = sItemMgr.GetItemMaxStarCount(ProtoId());
	return max_star_count == GetAttrCount();
}
