...
void protobuf_AssignDesc_GameServer_2eproto() {
  ...
  static const int PlayerAllData_offsets_[33] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(PlayerAllData, wanna_be_info_),
  };
...
void protobuf_AddDesc_GameServer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "lted\022:\n\rwanna_be_info\030! \001(\0132#.pb.GxDB_Wa"
    "nnaBeStrongerInfoAllInfo\"K\n\020CreatePlayer"
    "Data\022\022\n\naccount_id\030\001 \002(\004\022#\n\010all_data\030\002 \002"
    "(\0132\021.pb.PlayerAllData\"\246\001\n\025RegistCrossPla"
    "yerData\022&\n\013player_data\030\001 \002(\0132\021.pb.Player"
    "AllData\022$\n\006append\030\002 \001(\0132\024.pb.PlayerAppen"
    "dData\022\022\n\ncountry_id\030\003 \001(\r\022\022\n\naccount_id\030"
    "\004 \001(\004\022\027\n\017cross_Unique_id\030\005 \001(\r\"d\n\020Player"
    "AppendData\022%\n\006module\030\001 \001(\0132\025.pb.GxDB_Mod"
    "ules_Info\022)\n\010building\030\002 \001(\0132\027.pb.GxDB_Bu"
    "ildings_Info\"t\n\023SyncPlayerCacheData\022\022\n\na"
    "ccount_id\030\001 \002(\004\022#\n\010all_data\030\002 \002(\0132\021.pb.P"
    "layerAllData\022$\n\006append\030\003 \001(\0132\024.pb.Player"
    "AppendData\"^\n\013CQuickLogin\022\022\n\naccount_id\030"
    "\001 \001(\004\022\021\n\tplayer_id\030\002 \001(\004\022\023\n\013session_key\030"
    "\003 \001(\t\022\023\n\013platform_id\030\004 \001(\r\"3\n\013SQuickLogi"
    "n\022$\n\006result\030\001 \002(\0162\024.pb.QuickLoginResult\""
    "=\n\025GS2C_ItemOperateError\022\022\n\nerror_type\030\001"
    " \002(\r\022\020\n\010property\030\002 \001(\r\"V\n\030GS2C_Player_On"
    "line_State\022\023\n\013player_guid\030\001 \001(\004\022\023\n\013playe"
    "r_name\030\002 \001(\t\022\020\n\010isonline\030\003 \001(\010\"Q\n\024C2GS_I"
    "s_Player_Exist\022\023\n\013player_name\030\001 \002(\t\022\021\n\ty"
    "our_guid\030\002 \002(\004\022\021\n\tsend_from\030\003 \001(\r\"v\n\024GS2"
    "C_Is_Player_Exist\022\020\n\010is_exist\030\001 \002(\010\022\023\n\013p"
    "layer_name\030\002 \001(\t\022\021\n\tis_online\030\003 \001(\010\022\021\n\ty"
    "our_guid\030\004 \002(\004\022\021\n\tsend_from\030\005 \001(\r\" \n\014Fee"
    "dbackInfo\022\020\n\010feedback\030\001 \001(\t\"5\n\013FeedbackR"
    "et\022\022\n\nis_success\030\001 \002(\010\022\022\n\nerror_code\030\002 \001"
    "(\005\"\n\n\010NUll_Ret*\034\n\rKickErrorType\022\013\n\007RELOG"
    "IN\020\001*\372\001\n\020QuickLoginResult\022\027\n\023QUICK_LOGIN"
    "_SUCCESS\020\000\022!\n\035QUICK_LOGIN_SUCCESS_NO_PLA"
    "YER\020\001\022\031\n\025QUICK_LOGIN_KEY_ERROR\020\002\022\034\n\030QUIC"
    "K_LOGIN_KEY_PAST_DUE\020\003\022&\n\"QUICK_LOGIN_KE"
    "Y_UNAVAILABLE_SERVER\020\004\022%\n!QUICK_LOGIN_CA"
    "N_NOT_FIND_KEY_INFO\020\005\022\"\n\036QUICK_LOGIN_NEE"
    "D_RELOGIN_AGAIN\020\006", 3377);
...
const int PlayerAllData::kWannaBeInfoFieldNumber;
#endif  // !_MSC_VER
...
void PlayerAllData::InitAsDefaultInstance() {
  ...
  wanna_be_info_ = const_cast< ::pb::GxDB_WannaBeStrongerInfoAllInfo*>(&::pb::GxDB_WannaBeStrongerInfoAllInfo::default_instance());
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 32: {
        ...
        if (input->ExpectTag(266)) goto parse_wanna_be_info;
        break;
      }
...
void PlayerAllData::MergeFrom(const PlayerAllData& from) {
  ...
  if (from._has_bits_[32 / 32] & (0xffu << (32 % 32))) {
    if (from.has_wanna_be_info()) {
      mutable_wanna_be_info()->::pb::GxDB_WannaBeStrongerInfoAllInfo::MergeFrom(from.wanna_be_info());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void PlayerAllData::Swap(PlayerAllData* other) {
  if (other != this) {
    ...
    std::swap(wanna_be_info_, other->wanna_be_info_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
